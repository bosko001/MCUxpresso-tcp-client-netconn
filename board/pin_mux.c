...
board: FRDM-K64F
pin_labels:
- {pin_num: '67', pin_signal: PTB21/SPI2_SCK/FB_AD30/CMP1_OUT, label: 'D12[3]/LEDRGB_DRAGOMIR', identifier: LED_BLUE;LED_DRAGOMIR}
...
- pin_list:
  ...
  - {pin_num: '68', peripheral: GPIOB, signal: 'GPIO, 22', pin_signal: PTB22/SPI2_SOUT/FB_AD29/CMP2_OUT, direction: OUTPUT, gpio_init_state: 'true', drive_strength: high}
  - {pin_num: '67', peripheral: GPIOB, signal: 'GPIO, 21', pin_signal: PTB21/SPI2_SCK/FB_AD30/CMP1_OUT, identifier: LED_DRAGOMIR, direction: OUTPUT, gpio_init_state: 'true',
    drive_strength: high}
  - {pin_num: '38', peripheral: GPIOA, signal: 'GPIO, 4', pin_signal: PTA4/LLWU_P3/FTM0_CH1/NMI_b/EZP_CS_b, direction: INPUT, gpio_interrupt: kPORT_InterruptEitherEdge,
    pull_enable: disable, passive_filter: enable}
 * BE CAREFUL MODIFYING THIS COMMENT - IT IS YAML SETTINGS FOR TOOLS ***********
 */
/* clang-format on */
...
void BOARD_InitPins(void)
{
    ...
    gpio_pin_config_t LED_DRAGOMIR_config = {
        .pinDirection = kGPIO_DigitalOutput,
        .outputLogic = 1U
    };
    /* Initialize GPIO functionality on pin PTB21 (pin 67)  */
    GPIO_PinInit(BOARD_INITPINS_LED_DRAGOMIR_GPIO, BOARD_INITPINS_LED_DRAGOMIR_PIN, &LED_DRAGOMIR_config);
    ...
    /* Interrupt configuration on PORTA4 (pin 38): Interrupt on either edge */
    PORT_SetPinInterruptConfig(BOARD_INITPINS_SW3_PORT, BOARD_INITPINS_SW3_PIN, kPORT_InterruptEitherEdge);
    ...
    PORT_SetPinMux(BOARD_INITPINS_LED_DRAGOMIR_PORT, BOARD_INITPINS_LED_DRAGOMIR_PIN, kPORT_MuxAsGpio);
